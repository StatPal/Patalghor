This folder is intended for the use of fMRI and related imaging software, mainly intended to do neuroimaging analyzing, plotting etc at a very minimal working level. 
